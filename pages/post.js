    ...
    return (
      <div>
        <Header cosmic={ this.props.cosmic }/>
        {
          ...
          <div className="blog-post-hero" style={{backgroundImage: `url(${this.props.cosmic.post.metadata.hero.imgix_url})`}}/>
        }
              ...
              <div>
                <div className="blog__author">
                  <a href={`/author/${this.props.cosmic.post.metadata.author.slug}`}>
                    <div className="blog__author-image" style={{backgroundImage: `url(${this.props.cosmic.post.metadata.author.metafields[0].imgix_url}?w=100)`}}/>
                  </a>
                ...
                <div className="blog__teaser droid" dangerouslySetInnerHTML={{__html: this.props.cosmic.post.content}}/>
              </div>
            }
          </div>
        </main>
